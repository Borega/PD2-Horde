/** Hammerdin Holybolt Build Paladin Build
 */
js_strict(true);
...
AutoBuildTemplate[2] = {
    ...
    Update: function() {
        Config.AttackSkill = [-1, 0, 99, 0, 99, -1, -1]; // Use Might
        Config.LowManaSkill = [0, 99]; // Use Might while hitting stuff.
...
AutoBuildTemplate[6] = {
    ...
    Update: function() {
        ...
        Config.AttackSkill = [-1, 101, 99, 101, 99, 101, 99]; // Holy Bolt and Might for Secondary Skill/Aura.
    }
};
...
AutoBuildTemplate[12] = {
    ...
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function() {
            Config.AttackSkill = [-1, 101, 99, 101, 99, 101, 99]; // Use Blessed Aim
            Config.LowManaSkill = [0, 99]; // Use Blessed Aim while hitting stuff.
    }
};
...
AutoBuildTemplate[18] = {
    ...
    Update: function() {
        ...
        Config.AttackSkill = [-1, 101, 99, 101, 99, 101, 99]; // Blessed Hammer and Concentration!
        Config.LowManaSkill = [0, 99]; // Use Concentration while hitting stuff.
...
AutoBuildTemplate[24] = {
    ...
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function() {
        Config.AttackSkill = [-1, 101, 99, 101, 99, 121, 99]; // Holy Bolt and Meditation for Secondary Skill/Aura.
        Config.LowManaSkill = [-1, 99]; // Use Meditation while hitting stuff.
...
AutoBuildTemplate[30] = {
    ...
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function() {
        Config.AttackSkill = [-1, 101, 125, 101, 125, 121, 125]; // Holy Bolt and Meditation for Secondary Skill/Aura.
        Config.LowManaSkill = [-1, 125]; // Use meditation when out of mana
...
AutoBuildTemplate[40] = {
    ...
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function() {
		Config.AttackSkill = [-1, 121, 125, 121, 125, 101, 125]; 

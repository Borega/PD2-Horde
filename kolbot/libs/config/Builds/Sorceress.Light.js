/** Pure ChainLight Sorceress Build
 */
js_strict(true);
...
AutoBuildTemplate[12] = {
    ...
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function() {
        Config.AttackSkill = [-1, 38, -1, 38, -1, 0, 0]; // Lightening
    }
};
...
AutoBuildTemplate[19] = {
    SkillPoints: [-1],
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function() {
        Config.AttackSkill = [-1, 49, -1, 49, -1, 42, -1]; // Lightening
...
AutoBuildTemplate[24] = {
    ...
    Update: function() {
		Config.AttackSkill = [-1, 49, -1, 53, -1, 42, -1]; // ChainLightening
...
AutoBuildTemplate[50] = {
    ...
    Update: function() {
        ...
        Config.AttackSkill = [-1, 49, -1, 53, -1, -1, -1]; // no more static for immunes
    }
};

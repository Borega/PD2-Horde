/** Hammerdin Salvation Paladin Build
 */
js_strict(true);
...
AutoBuildTemplate[2] = {
    ...
    Update: function() {
        Config.AttackSkill = [-1, 0, 99, 0, 99, -1, -1]; // Use Prayer
...
AutoBuildTemplate[6] = {
    ...
    Update: function() {
        ...
        Config.StashGold = 1000; // Minimum amount of gold to stash.
            Config.AttackSkill = [-1, 0, 99, 0, 99, 101, 99]; // Holy Bolt and prayer for Secondary Skill/Aura.
            Config.LowManaSkill = [0, 99]; // Use Defiance while hitting stuff.
    }
};
...
AutoBuildTemplate[18] = {
    ...
    Update: function() {
        ...
        Config.AttackSkill = [-1, 112, 115, 112, 115, 101, 115]; // Blessed Hammer and vigor
...
AutoBuildTemplate[24] = {
    ...
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function() {
        Config.LowManaSkill = [-1, 115]; // no more hitting stuff
...
AutoBuildTemplate[30] = {
    ...
    StatPoints: [-1, -1, -1, -1, -1],
    Update: function() {
        Config.AttackSkill = [-1, 112, 125, 112, 125, 97, 125]; // salvation / smite  for Secondary Skill/Aura.

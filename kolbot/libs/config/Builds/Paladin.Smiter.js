...
AutoBuildTemplate[2] = {
    ...
    Update: function() {
        Config.AttackSkill = [-1, 97, 98, 97, 98, -1, -1]; // Use Might
...
AutoBuildTemplate[30] = {
    ...
    Update: function() {
        ...
        Config.AttackSkill = [-1, 97, 122, 97, 122, -1, -1]; // Fanatism + smite
        Config.LowManaSkill = [97, 122]; // Fanatism + smite
